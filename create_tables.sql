CREATE TABLE deeds (
`acct` varchar(14) NOT NULL COMMENT 'Account Number',
`dos` varchar(10) COMMENT 'Date of Sale Format MM/DD/YYYY',
`clerk_yr` int COMMENT 'Clerk Year',
`clerk_id` varchar(20) COMMENT 'Clerk ID Number',
`deed_id` int NOT NULL COMMENT 'Deed Id'
); 

 CREATE TABLE owners (
`acct` varchar(14) NOT NULL COMMENT 'Account Number',
`ln_num` int NOT NULL COMMENT 'Owner Line Number',
`name` varchar(100) COMMENT  'Owner Name',
`aka` varchar(50) COMMENT 'Owner AKA',
`pct_own` decimal COMMENT 'Percent Ownership'
); 
...
`pct` decimal COMMENT 'Percent Allocated'
); 
